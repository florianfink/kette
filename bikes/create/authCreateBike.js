...
const makeDepdenencies = require("./authCreateBikeDependencyMaker");

exports.makeCreateBike = deps => {
    ...
    const create = async function(
        ...
        try {
            ...
            const userRecord = await deps.getOrCreateUserRecord(
                userId,
                creatorId
            );
            ...
            const transactionHash = smartContractService.register(
                vendor,
                serialNumber,
                frameNumber,
                ipfsImageHash,
