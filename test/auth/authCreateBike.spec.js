const { makeCreateBike } = require("../../bikes/create/authCreateBike");
...
describe("integration test for registryForUser", function() {
    ...
    it("returns valid transaction", async () => {
        const testDependencies = {
            ...
            getOrCreateUserRecord: userId => {
                return {
                    ethAddress: "0x5ae6A13cF333d7747DC2f8224E4ED700429fEe38"
                };
            }
        };

        const createBike = makeCreateBike(testDependencies);
